    ...
    <div class="dashboard-right-sidebar-inner">
        ...
        <section class="dashboard-right-sidebar-section">
            ...
            <div class="dashboard-right-sidebar-list">
                <?php foreach ($rightSidebarUsers as $rightSidebarUser): ?>
                    <a class="dashboard-right-sidebar-user" href="<?= htmlspecialchars(appUrl('friends'), ENT_QUOTES, 'UTF-8') ?>">
                        <span class="dashboard-right-sidebar-avatar-wrap">
                            <span class="dashboard-right-sidebar-avatar" style="background:<?= htmlspecialchars($rightSidebarUser['color'], ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars($rightSidebarUser['initials'], ENT_QUOTES, 'UTF-8') ?></span>
                            <span class="dashboard-right-sidebar-status is-<?= htmlspecialchars($rightSidebarUser['status'], ENT_QUOTES, 'UTF-8') ?>" aria-label="<?= htmlspecialchars(ucfirst($rightSidebarUser['status']), ENT_QUOTES, 'UTF-8') ?>"></span>
                        </span>
                        <span class="dashboard-right-sidebar-user-copy">
                            <span class="dashboard-right-sidebar-user-name"><?= htmlspecialchars($rightSidebarUser['name'], ENT_QUOTES, 'UTF-8') ?></span>
                            <span class="dashboard-right-sidebar-user-meta"><?= htmlspecialchars($rightSidebarUser['game'], ENT_QUOTES, 'UTF-8') ?> · <?= htmlspecialchars($rightSidebarUser['activity'], ENT_QUOTES, 'UTF-8') ?></span>
                        </span>
                    </a>
                <?php endforeach; ?>
            </div>
