...
CREATE INDEX IF NOT EXISTS idx_game_catalog_name ON game_catalog(name);
CREATE INDEX IF NOT EXISTS idx_game_catalog_active_name ON game_catalog(is_active, name);
...
CREATE TABLE IF NOT EXISTS user_companies (
    user_id BIGINT NOT NULL,
    company_id BIGINT NOT NULL,
    role VARCHAR(20) NOT NULL DEFAULT 'developer' CHECK (role IN ('developer', 'publisher')),
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS posts (
    ...
    topic_type VARCHAR(20) NULL CHECK (topic_type IN ('game', 'developer', 'publisher')),
    ...
    CONSTRAINT fk_posts_game
        FOREIGN KEY (game_id) REFERENCES game_catalog(id) ON DELETE SET NULL
);
...
INSERT INTO game_catalog (name, slug, description, developer, publisher)
VALUES
('Valorant', 'valorant',
